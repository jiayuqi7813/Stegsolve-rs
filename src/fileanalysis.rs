use gtk::prelude::*;
use gtk::{Dialog, ScrolledWindow, TextView, TextBuffer, TextTagTable, Button};
use std::fs::File;
use std::io::Read;
...
pub fn show_file_analysis_dialog(parent: Option<&gtk::Window>, file_path: &str) {
    let report = analyse_file_format(file_path);
    ...
    dialog.content_area().append(&close_button);
